% Total run script for CNMF_E, for RM036 data
...
patch_size = [50, 50]; %patch size
overlap = [15 15]; %patch overlap
min_patch_sz = [16,16];
...
[merged_ROI, newIDs] = neuron_full.MergeNeighbors(5,'center');
...
saveName = [fdir,fnam(1:end-4),'_results.mat'];
